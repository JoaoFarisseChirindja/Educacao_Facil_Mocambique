...
<?php include 'header.php'; ?>
  ...
  <main>
    ...
    <article class="container article">
      ...
      <h2 class="h2 article-title">Ola <?= $fetch_perfil['nome']; ?></h2>
      ...
      <section class="home">
        ...
        <div class="card profile-card">
          ...
          <button class="card-menu-btn icon-box" aria-label="More" data-menu-btn>
            <span class="material-symbols-rounded  icon">mais detalhes </span>
          </button>
          ...
          <ul class="ctx-menu">
            ...
            <li class="ctx-item">
              <button class="ctx-menu-btn icon-box">
                <span class="material-symbols-rounded  icon" aria-hidden="true">editar</span>
            ...
            <li class="ctx-item">
              <button class="ctx-menu-btn red icon-box">
                <span class="material-symbols-rounded  icon" aria-hidden="true">Eliminar </span>

                <span class="ctx-menu-text">Deactivado</span>
              </button>
            </li>
          ...
          <div class="profile-card-wrapper">
            ...
            <figure class="card-avatar">
              <img src="img/<?= $fetch_perfil['perfil']; ?>" alt="poster" width="48" height="48">
            </figure>

            <div>
              <p class="card-title"><?= $fetch_perfil['nome']; ?></p>

              <p class="card-subtitle">Educacao facil Moz</p>
            </div>
          ...
          <ul class="contact-list">
            ...
            <li>
              <a href="mailto:sabo@gmail.com" class="contact-link icon-box">
                <span class="material-symbols-rounded  icon">Email</span>

                <p class="text"><?= $fetch_perfil['email']; ?></p>
              </a>
            </li>

            <li>
              <a href="tel:842756666" class="contact-link icon-box">
                <span class="material-symbols-rounded  icon">call</span>

                <p class="text"><?= $fetch_perfil['contacto']; ?></p>
              </a>
            </li>
          ...
          <ul class="progress-list">
            ...
            <li class="progress-item">
              ...
              <div class="progress-label">
                <p class="progress-title">Projecto</p>
            ...
            <li class="progress-item">
              ...
              <div class="progress-label">
                <p class="progress-title"> Rating</p>
        ...
        <div class="card-wrapper">
          ...
          <div class="card task-card">
            ...
            <div class="card-icon icon-box green">
              ...
              <?php
                $select_prof = $conn->prepare("SELECT * FROM `professores`");
                $select_prof->execute();
                $numero_de_prof = $select_prof->rowCount();
              ?>
            <div>
              <data class="card-data" value="<?= $numero_de_prof; ?>"><?= $numero_de_prof; ?></data>
